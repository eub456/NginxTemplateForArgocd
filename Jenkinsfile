            ...
            steps {
                script {
                    sshagent (credentials: ['argoCD']) {
                        ...
                        sh "ssh -o StrictHostKeyChecking=no ubuntu@3.34.127.63 argocd app create test --repo https://github.com/eub456/NginxTemplateForArgocd.git --sync-policy automated --path templates --dest-server https://kubernetes.default.svc --dest-namespace default"
                    }
                }
            }
        }
